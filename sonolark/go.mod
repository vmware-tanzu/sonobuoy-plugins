module github.com/vmware-tanzu/sonobuoy-plugins/sonolark

go 1.17

require (
	github.com/cruise-automation/isopod v1.8.6
...
require (
	...
	istio.io/api v0.0.0-20210204223132-d90b2f705958 // indirect
